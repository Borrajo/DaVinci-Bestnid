...
Producto.find_or_create_by(nombre: "Diseños originales de Bestnid", descripcion: "Estos son los diseños que dieron vida a Bestnid, fueron creados por Cristian siguiendo rigurosos patrones y reglas del diseño web. Ahora me fueron entregados y decidí venderlos porque creo que un objeto tan ÚNICO debe cotizarse muy alto. Son 8 paginas a todo color tal cual se ven en este sitio. Como verán fueron respetadas a rajatabla por los desarrolladores. Ojala alguien los necesite más que yo.", 
...
Producto.find_or_create_by(nombre: "Electrodomesticos", descripcion: "Odio a mi señora. Todos estos son suyos, oferta y llevate el que quieras, voy a seguir postulando hasta que no me quede con ninguno.", 
...
Producto.find_or_create_by(nombre: "fldsmdfr (maquina de comida)", descripcion: "Esto es una revolución, le metes agua por arriba y por abajo sale comida, Puede programarse para diferentes tipos de comida! especial para días de lluvia. DIVERTIDISIMO", 
	user_id: 7, cantidad_preguntas: 0, categoria_id: 3, foto: "http://www.spot.ph/files/2014/06/1403758900-Cloudy-With-A-Chance",
	created_at: DateTime.new(2014,6,9), fecha_finalizacion: DateTime.new(2014,12,15), finalizado: false)

Producto.find_or_create_by(nombre: "Papas Antares", descripcion: "La imagen es a modo ilustrativo.. La porción trae lo que me quedó de anoche y se entrega en bandeja de plástico", 
...
Producto.find_or_create_by(nombre: "Nariz de Pinocho", descripcion: "Ejemplar único : es la verdadera nariz de Pinocho mide 1.2mts y viene con rosca para sacar y poner. Fue conseguida en Disney en un set de filmación. Ya no se que hacer con ella..", 
...
Producto.find_or_create_by(nombre: "Ponzio", descripcion: "Hola soy la mama de Ponzio y ya estoy cansada de fumarmelo aca en casa. En la imagen se aprecia su mejor pase del año, asistencia al alcanza pelotas. Desde chiquito que sufre problemas intestinales y mas que nada se le enfría el pechito, asi que mucho abrigo. Su deporte preferido es escuchar como la pupular se cansa de dedicarme barbaridades, un amor. Besos", 
