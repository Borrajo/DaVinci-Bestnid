...
Usuario.find_or_create_by(nombre: "Carlos", apellido: "Maidana", email: "a@a", telefono: "0114234514", clave: "123456", fecha_nacimiento: DateTime.new(1990,2,3))
Usuario.find_or_create_by(nombre: "Catalina", apellido: "Perez", email: "b@b", telefono: "0114353152", clave: "123456", fecha_nacimiento: DateTime.new(1992,5,3))
Usuario.find_or_create_by(nombre: "Sergio", apellido: "Ramirez", email: "c@c", telefono: "0114514789", clave: "123456", fecha_nacimiento: DateTime.new(1985,8,3))
...
Producto.find_or_create_by(nombre: "Llama", descripcion: "Llama adulta oriunda de Tilcara. Es mansita", 
	...
	created_at: DateTime.new(2014,3,6), fecha_finalizacion: DateTime.new(2014,2,5) + 20.day)
Producto.find_or_create_by(nombre: "Espejo", descripcion: "Espejo sin marco. Medidas: 0.8m x 1.2m", 
	...
	created_at: DateTime.new(2014,4,7), fecha_finalizacion: DateTime.new(2014,2,5) + 15.day)
Producto.find_or_create_by(nombre: "Kriptonita", descripcion: "200 gramos de Kriptonita", 
	...
	created_at: DateTime.new(2014,5,8), fecha_finalizacion: DateTime.new(2014,2,5) + 28.day)
Producto.find_or_create_by(nombre: "Aceite y Vinagre", descripcion: "200ml de aceite y 300ml de vinagre. No incluye fascos", 
	...
	created_at: DateTime.new(2014,6,9), fecha_finalizacion: DateTime.new(2014,2,5) + 15.day)

puts "Agrego una pregunta"
Producto.find(2).preguntas.find_or_create_by(pregunta: "Cuando pesa?");